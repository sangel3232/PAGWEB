...
const DOORS: DoorConfig[] = [
  // LEFT SIDE — 3 doors (Composición, Producción, Proyectos y Remixes)
  {
    ...
    hotspotLeft: '6%', hotspotTop: '22%', hotspotLeftMobile: '10%', hotspotTopMobile: '32%', side: 'left',
  ...
  },
  {
    ...
    hotspotLeft: '17%', hotspotTop: '33%', hotspotLeftMobile: '20%', hotspotTopMobile: '36%', side: 'left',
  ...
  },
  {
    ...
    hotspotLeft: '27%', hotspotTop: '44%', hotspotLeftMobile: '28%', hotspotTopMobile: '40%', side: 'left',
  ...
  // RIGHT SIDE — 3 doors
  {
    ...
    hotspotLeft: '83%', hotspotTop: '34%', hotspotLeftMobile: '90%', hotspotTopMobile: '32%', side: 'right',
  ...
  },
  {
    ...
    hotspotLeft: '72%', hotspotTop: '44%', hotspotLeftMobile: '80%', hotspotTopMobile: '36%', side: 'right',
  ...
  },
  {
    ...
    hotspotLeft: '62%', hotspotTop: '54%', hotspotLeftMobile: '72%', hotspotTopMobile: '40%', side: 'right',
    route: '/ceo',
    color: '#E8C96A',
  },
]
