...
const DOORS: DoorConfig[] = [
  ...
  },
  {
    ...
    hotspotLeft: '82%', hotspotTop: '33%', hotspotLeftMobile: '86%', hotspotTopMobile: '36%', side: 'right',
  ...
  },
  {
    ...
    hotspotLeft: '72%', hotspotTop: '44%', hotspotLeftMobile: '78%', hotspotTopMobile: '40%', side: 'right',
