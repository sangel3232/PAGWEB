...
const DOORS: DoorConfig[] = [
  // LEFT SIDE — 3 doors (Composición, Producción, Proyectos y Remixes)
  {
    ...
    hotspotLeft: '6%', hotspotTop: '32%', hotspotLeftMobile: '8%', hotspotTopMobile: '29%', side: 'left',
  ...
  },
  {
    ...
    hotspotLeft: '17%', hotspotTop: '43%', hotspotLeftMobile: '17%', hotspotTopMobile: '43%', side: 'left',
  ...
  },
  {
    ...
    hotspotLeft: '27%', hotspotTop: '54%', hotspotLeftMobile: '26%', hotspotTopMobile: '56%', side: 'left',
  ...
  // RIGHT SIDE — 3 doors (Derechos, Marketing, CEO)
  {
    ...
    hotspotLeft: '83%', hotspotTop: '34%', hotspotLeftMobile: '70%', hotspotTopMobile: '56%', side: 'right',
  ...
  },
  {
    ...
    hotspotLeft: '72%', hotspotTop: '44%', hotspotLeftMobile: '90%', hotspotTopMobile: '29%', side: 'right',
  ...
  },
  {
    ...
    hotspotLeft: '62%', hotspotTop: '54%', hotspotLeftMobile: '79%', hotspotTopMobile: '43%', side: 'right',
    route: '/ceo',
    color: '#E8C96A',
  },
]
